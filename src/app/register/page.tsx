    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-50 to-blue-100 text-gray-800">
      ...
      <main className="flex-grow flex justify-center items-center p-6 sm:p-8 md:p-12">
        <form
          ...
          className="bg-white p-8 sm:p-10 rounded-xl w-full max-w-3xl shadow-xl border border-gray-200 animate-slide-up"
        >
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 flex items-center justify-center gap-2 mb-8">
            <User className="h-8 w-8 text-blue-600" aria-hidden="true" />
            Create an Account
          </h2>

          {error && (
            <div className="bg-red-50 text-red-700 p-3 rounded-lg flex items-center gap-2 mb-6 animate-slide-down">
              <svg
                className="h-5 w-5"
                fill="none"
                viewBox="0 0 24 24"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 space-y-0">
            ...
            <div className="relative md:col-span-2">
              ...
              >
                ...
                <option value="PARTIAL">Premium</option>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="md:col-span-2 flex items-center justify-center gap-2 w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-3 rounded-lg hover:from-blue-700 hover:to-blue-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-md"
